/*
  Toggle class of navbar after a scroll offset

  Derived from https://github.com/enkindle/shrinking-header/
  Demo: https://www.cssscript.com/demo/smart-sticky-header-navigation-with-vanilla-javascript-shrinking-header/
*/
...
(function() {
  ...
  function init() {
    window.addEventListener('scroll', function() {
        headerSize('custom-navbar', 'scroll-top');
    }, false);
  }
